...
const cases = [
  ...
  ['Identitätsnachweis', 'BUNDESREPUBLIK DEUTSCHLAND PERSONAL AUSWEIS Dokument Nr. L01X00T471 Geburtsdatum Staatsangehörigkeit'],
  ['Identitätsnachweis', 'IDENTITY CARD DOCUMENT NO L01X00T471 DATE OF BIRTH NATIONALITY IDD<<<<<<<<'],
  ['Identitätsnachweis', 'BUNDESREPUBLIK DEUTSCHLAND PERS0NALAUSWEIS GEBURTSDATUM'],
