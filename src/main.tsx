  ...
  if (screen === 'welcome') {
    return (
      <main className="app welcome">
        <section>
          <img className="startBrand" src="/mezax-start-transparent.png" srcSet="/mezax-start-transparent.png 1x, /mezax-start-transparent@2x.png 2x" alt="MEZAX – Teile Dokumente. Nicht deine Daten." />
        </section>
        <div className="trust">
