  ...
  if (screen === 'welcome') {
    return (
      <main className="app welcome">
        <section>
          <img className="startBrand" src="/mezax-start-exact.png" srcSet="/mezax-start-exact.png 1x, /mezax-start-exact@2x.png 2x" alt="MEZAX – Teile Dokumente. Nicht deine Daten." />
        </section>
        <div className="trust">
